...
contextBridge.exposeInMainWorld('resolveAPI', {
    ...
    // Clips
    selectClipsToAdd: () => ipcRenderer.invoke('resolve:selectClipsToAdd'),
    ...
    // Render
    renderTimeline: (renderPresetName, targetDirPath, targetClipName) => ipcRenderer.invoke('resolve:renderTimeline', renderPresetName, targetDirPath, targetClipName),
    // RenderPreset
